...
type Invoker interface {
    ...
    InvokeReactor(ctx context.Context, req *ReactorRequest) errors.Error
    InvokeReactorAsync(ctx context.Context, req *ReactorRequest) errors.Error
}
...
func (in *Invoke) InvokeReactor(ctx context.Context, req *ReactorRequest) errors.Error {
    reqByte, err := req.MarshalRequest()
    if err != nil {
        return err
    }
...
func (in *Invoke) InvokeReactorAsync(ctx context.Context, req *ReactorRequest) errors.Error {
    reqByte, err := req.MarshalRequest()
    if err != nil {
        return err
    }
