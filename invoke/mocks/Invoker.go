...
// InvokeSaga provides a mock function with given fields: ctx, req
func (_m *Invoker) InvokeSaga(ctx context.Context, req *invoke.SagaRequest) errors.Error {
	ret := _m.Called(ctx, req)

	var r0 errors.Error
	if rf, ok := ret.Get(0).(func(context.Context, *invoke.SagaRequest) errors.Error); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(errors.Error)
...
// InvokeSagaAsync provides a mock function with given fields: ctx, req
func (_m *Invoker) InvokeSagaAsync(ctx context.Context, req *invoke.SagaRequest) errors.Error {
	ret := _m.Called(ctx, req)
