...
func (s *EventStoreSuite) WithSnapshot() *EventStoreSuite {
	s.es = eventstore.New(getDB(), eventstore.WithSnapshot(1))
...
func (s *EventStoreSuite) WithMockStorageAndSnapshot() *EventStoreSuite {
	s.mockStore = &mocks.Storage{}
	s.es = eventstore.New(s.mockStore, eventstore.WithSnapshot(1))
