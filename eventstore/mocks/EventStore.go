...
func (_m *EventStore) GetEvents(ctx context.Context, aggID string, seq int64) ([]*event.Msg, errors.Error) {
...
func (_m *EventStore) PublishEventsWithMetadata(ctx context.Context, metadata map[string]string, evts ...proto.Message) errors.Error {
	_va := make([]interface{}, len(evts))
	for _i := range evts {
		_va[_i] = evts[_i]
	}
