...
var (
	...
	ErrUnableGetEventSource     = errors.InternalError("ErrUnableGetEventStore", "Unable to get")
	ErrUnableSaveEventStore     = errors.InternalError("ErrUnableSaveEventStore", "Unable to save")
	ErrUnableSaveEventSource    = errors.InternalError("ErrUnableSaveEventSource", "Unable to save")
	ErrUnableSaveDLQMessages    = errors.InternalError("ErrUnableSaveDLQMessages", "Unable to save DLQ messages")
	...
	ErrUnableGetDLQMsg          = errors.InternalError("ErrUnableGetDLQMsg", "Unable get DLQ message")
	...
	ErrDLQMsgNotFound           = errors.InternalError("ErrDLQMsgNotFound", "DLQ message not found")
